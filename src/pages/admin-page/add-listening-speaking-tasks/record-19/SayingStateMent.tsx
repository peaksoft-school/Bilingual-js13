                  ...
                  <TableContainerBox>
                     ...
                     <SubTitleBox>
                        <LeftBox>
                           <h2>Test Question </h2>
                           <p>
                              <span>Question Title:</span> Record yourself
                              saying the statement below
                           </p>
                           <p>
                              <span>Duration (in minutes):</span> 0:30
                           </p>
                           <p>
                              <span>Question Type:</span> Record saying
                              statement
                           </p>
                           <p>
                              <span>Statement:</span> “Do you like my car? yes
                              or no?”
                           </p>
                        </LeftBox>
                        <RightBox>
...
export default SayingStateMent
