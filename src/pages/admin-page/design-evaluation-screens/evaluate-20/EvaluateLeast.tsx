                  ...
                  <TableContainerBox>
                     ...
                     <SubTitleBox>
                        <LeftBox>
                           <h2>Test Question </h2>
                           <p>
                              <span>Question Title:</span> Respond to the
                              questionin at least 30 words
                           </p>
                           <p>
                              <span>Duration (in minutes):</span> 0:30
                           </p>
                           <p>
                              <span>Question Type:</span> Respond in at least N
                              words
                           </p>
                           <p>
                              <span>Mimimum number of words:</span> 30
                           </p>
                           <p>
                              <span>Question Statement:</span> “Describe a time
                              you were surprised? What happened?”
                           </p>
                        </LeftBox>
                        <RightBox>
                           <h2>Evaluation</h2>
